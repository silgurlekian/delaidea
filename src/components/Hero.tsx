  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto w-full relative">
          ...
          <div className={`space-y-8 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-8'
            ...
            <div className="space-y-4">
              <h1 className="space-y-2">
                ...
                <div className="text-6xl md:text-8xl lg:text-8xl font-black leading-none ml-12">
                ...
                <div className="bg-black p-4 transform rotate-1">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {[
                      ...
                      <span key={techKey} className="bg-yellow-400 text-black px-2 py-1 text-xs font-black">
                        {t(techKey)}
                      </span>
                    ))}
                  </div>
        ...
        {/* Description */}
        <div className="bg-black text-white p-6 max-w-4xl mx-auto text-center">
        ...
        {/* CTA Buttons */}
        <div className="flex flex-col sm:flex-row gap-6 pt-8 mt-4">
          <Button
